...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 所有订单</h3>
            <div class="row mb">
                <!-- page start-->
                    ...
                    <c:if test="${not empty olist.date}">
                        ...
                        <c:forEach items="${olist.date}" var="o">
                            <tr class="gradeA">
                                ...
                                <td>${o.payment}</td>
                                <c:if test="${ o.payment_type eq 1}">
                                <td class="hidden-phone">在线支付</td>
                                </c:if>
                                <c:if test="${ o.status eq 0}">
                                <td class="center hidden-phone">已取消</td>
                                </c:if>
                                <c:if test="${ o.status eq 10}">
                                    <td class="center hidden-phone">未付款</td>
                                </c:if>
                                <c:if test="${ o.status eq 20}">
                                    <td class="center hidden-phone">待发货</td>
                                </c:if>
                                <c:if test="${ o.status eq 40}">
                                    <td class="center hidden-phone">已发货</td>
                                </c:if>
                                <c:if test="${ o.status eq 50}">
                                    <td class="center hidden-phone">交易成功</td>
                                </c:if>
                                <c:if test="${ o.status eq 60}">
                ...
                <c:if test="${not empty olist and olist.status ne 200}">
                    <h3>${olist.msg}</h3>
                </c:if>
                <!-- page end-->
            </div>
